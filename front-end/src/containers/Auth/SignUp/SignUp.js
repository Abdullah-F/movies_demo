...
class SignUp extends Component {
  ...
  submintHandler = event => {
    ...
    formData.append(
      ...
      this.state.signUpFrom.password_confirmation.value
    );
  ...
  getForm() {
    ...
    let form = (
      <form>
        {inputElements}
        <Button buttonType="Success" clicked={this.submintHandler}>
          Submit
        </Button>
      </form>
    );
  ...
  render() {
    return <div className={Classes.SignUp}>{this.getForm()}</div>;
  }
}
